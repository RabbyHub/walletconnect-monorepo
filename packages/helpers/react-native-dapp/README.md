# `@rabby-wallet/wc-react-native-dapp`
...
To get started, install `@rabby-wallet/wc-react-native-dapp`:

```sh
yarn add @rabby-wallet/wc-react-native-dapp
```
...
import WalletConnectProvider from '@rabby-wallet/wc-react-native-dapp';
...
```typescript
import * as React from "react";
import { withWalletConnect, useWalletConnect } from "@rabby-wallet/wc-react-native-dapp";
import AsyncStorage from "@react-native-async-storage/async-storage";
...
```typescript
import AsyncStorage from '@react-native-async-storage/async-storage';
import { useWalletConnect, withWalletConnect } from '@rabby-wallet/wc-react-native-dapp';
import * as React from 'react';
...
`@rabby-wallet/wc-react-native-dapp` also permits you to customize the presentation of the [`QrcodeModal`](./src/components/QrcodeModal.tsx). This is achieved by passing the [**Render Callback**]() prop, `renderQrcodeModal`, to our calls to `withWalletConnect` or instances of `WalletConnectProvider`.
...
import {
  ...
  WalletService,
} from '@rabby-wallet/wc-react-native-dapp';
import * as React from 'react';
